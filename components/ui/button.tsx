...
/**
 * base-ui's default scale is built for a mouse (32px buttons). Every variant grows to a 44px touch
 * target under `pointer: coarse` — the media query that actually asks "is this a fingertip?", so an
 * iPad at 768px and a phone at 390px both get real targets while a desktop stays dense.
 */
